...
static struct lcm_cmds init_code[] = {
	...
	{0x00,0x00,0x02,0xa5,0x42,0x42},
	{0x00,0x00,0x03,0xaa,0x88,0x88},
	{0x00,0x00,0x03,0xe8,0x16,0x40},
	{0x00,0x00,0x03,0xe3,0x01,0x18},
	{0x00,0x00,0x03,0xe1,0x10,0x0a},

	{0x00,0x00,0x02,0xac,0x00},
	{0x00,0x00,0x02,0xaf,0x67},

	{0x00,0x00,0x03,0xa6,0x29,0x29},
	{0x00,0x00,0x03,0xa7,0x27,0x27},
	{0x00,0x00,0x03,0xa8,0x17,0x17},
	{0x00,0x00,0x03,0xa9,0x26,0x26},

	//----gamma setting---------//
	{0x00,0x00,0x07,0xf0,0x02,0x02,0x00,0x0a,0x18,0x0d},
	{0x00,0x00,0x07,0xf1,0x01,0x03,0x00,0x1c,0x22,0x0e},
	{0x00,0x00,0x07,0xf2,0x0d,0x08,0x39,0x04,0x04,0x4a},
	{0x00,0x00,0x07,0xf3,0x0f,0x08,0x42,0x03,0x05,0x4f},
	{0x00,0x00,0x07,0xf4,0x08,0x11,0x12,0x22,0x29,0x0f},
	{0x00,0x00,0x07,0xf5,0x07,0x0e,0x0e,0x22,0x29,0x0f},
...
static int32_t gc9305_reset(struct panel_spec *self){
	return 0;
}
...
static struct panel_spec lcd_gc9305_spi_spec = {
	.width = 240,
	.height = 320,
	.bpp = 2,
	.fps = 33,
...
static struct panel_cfg lcd_gc9305_spi = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x9305,
	.lcd_name = "lcd_gc9305_rgb_spi",
	.panel = &lcd_gc9305_spi_spec,
};
static int __init lcd_gc9305_spi_init(void)
{
	return sprdfb_panel_register(&lcd_gc9305_spi);
}

subsys_initcall(lcd_gc9305_spi_init);
