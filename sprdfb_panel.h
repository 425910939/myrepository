...
typedef void (*spi_send_cmd_t)(uint8_t* data);
typedef void (*spi_send_data_t)(uint8_t* data);
typedef void (*spi_read_t)(uint8_t *data);
...
struct ops_spi{
	void (*spi_send_cmd)(uint8_t* data);
